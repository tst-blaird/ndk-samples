...
sensorgraph::sensorgraph() : sensorDataIndex(0) {}
...
GLuint sensorgraph::createProgram(const std::string& pVertexSource, const std::string& pFragmentSource) {
...
GLuint sensorgraph::loadShader(GLenum shaderType, const std::string& pSource) {
